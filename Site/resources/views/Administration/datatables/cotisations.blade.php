        ...
        <div class="panel ">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="ti-list"></i> Liste des cotisations
                </h3>
                <span class="pull-right">
                <a href="{{route('cotisation-create')}}"><i class="fa fa-fw ti-plus addpanel clickable"></i></a>
                        <i class="fa fa-fw addpanel clickable"></i>
                    </span>
            </div>
            <div class="panel-body">
                <div class="table-responsive">
                    <table id="mytable" class="table table-bordred table-striped">
                        ...
                        <tbody>
                                @foreach($cotisations as $users)
                        <tr>                          
                            <td>{{ $users->compte_id }}</td>
                            <td>{{ $users->operation }}</td>
                            <td>{{ $users->montant }}</td>
