...
<head>
    ...
    <link href="{{ asset('asset/vendors/themify/css/themify-icons.css') }}" rel="stylesheet" type="text/css"/>
    <!-- end of global css-->
    <!-- page level styles-->
    <link href="{{ asset('asset/vendors/bootstrapvalidator/css/bootstrapValidator.min.css') }}" rel="stylesheet"/>
    <link href="{{ asset('asset/css/forgot_password.css') }}" rel="stylesheet">
...
<script src="{{ asset('asset/js/custom_js/forgot_password.js') }}" type="text/javascript"></script>
